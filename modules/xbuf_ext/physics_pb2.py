...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='xbuf_ext',
  syntax='proto3',
  serialized_pb=_b('\n\x16xbuf_ext/physics.proto\x12\x08xbuf_ext\x1a\x15xbuf/primitives.proto\"\xcf\x01\n\x0bPhysicsData\x12&\n\trigidbody\x18\x01 \x01(\x0b\x32\x13.xbuf_ext.RigidBody\x12(\n\nconstraint\x18\x02 \x01(\x0b\x32\x14.xbuf_ext.Constraint\"n\n\x0cPhysicsShape\x12\t\n\x05undef\x10\x00\x12\t\n\x05smesh\x10\x01\x12\x0b\n\x07ssphere\x10\x02\x12\t\n\x05shull\x10\x03\x12\x08\n\x04sbox\x10\x04\x12\x0c\n\x08scapsule\x10\x05\x12\r\n\tscylinder\x10\x06\x12\t\n\x05scone\x10\x07\"d\n\nConstraint\x12\n\n\x02id\x18\x01 \x01(\t\x12\r\n\x05\x61_ref\x18\x02 \x01(\t\x12\r\n\x05\x62_ref\x18\x03 \x01(\t\x12,\n\x07generic\x18\x04 \x01(\x0b\x32\x1b.xbuf_ext.ConstraintGeneric\"\x81\x02\n\x11\x43onstraintGeneric\x12\x1a\n\x06pivotA\x18\x01 \x01(\x0b\x32\n.xbuf.Vec3\x12\x1a\n\x06pivotB\x18\x02 \x01(\x0b\x32\n.xbuf.Vec3\x12$\n\x10upperLinearLimit\x18\x03 \x01(\x0b\x32\n.xbuf.Vec3\x12$\n\x10lowerLinearLimit\x18\x04 \x01(\x0b\x32\n.xbuf.Vec3\x12%\n\x11upperAngularLimit\x18\x05 \x01(\x0b\x32\n.xbuf.Vec3\x12%\n\x11lowerAngularLimit\x18\x06 \x01(\x0b\x32\n.xbuf.Vec3\x12\x1a\n\x12\x64isable_collisions\x18\x07 \x01(\x08\"\xc6\x03\n\tRigidBody\x12\n\n\x02id\x18\x01 \x01(\t\x12/\n\x04type\x18\x02 \x01(\x0e\x32!.xbuf_ext.RigidBody.RigidBodyType\x12\x31\n\x05shape\x18\x03 \x01(\x0e\x32\".xbuf_ext.PhysicsData.PhysicsShape\x12\x0c\n\x04mass\x18\x04 \x01(\x02\x12\x10\n\x08\x66riction\x18\x05 \x01(\x02\x12\x16\n\x0e\x61ngularDamping\x18\x06 \x01(\x02\x12\x15\n\rlinearDamping\x18\x07 \x01(\x02\x12\x0e\n\x06margin\x18\x08 \x01(\x02\x12\x13\n\x0brestitution\x18\t \x01(\x02\x12!\n\rangularFactor\x18\n \x01(\x0b\x32\n.xbuf.Vec3\x12 \n\x0clinearFactor\x18\x0b \x01(\x0b\x32\n.xbuf.Vec3\x12\x13\n\x0bisKinematic\x18\x0c \x01(\x08\x12\x16\n\x0e\x63ollisionGroup\x18\r \x01(\x05\x12\x15\n\rcollisionMask\x18\x0e \x01(\x05\"L\n\rRigidBodyType\x12\t\n\x05undef\x10\x00\x12\t\n\x05tnone\x10\x01\x12\x0b\n\x07tstatic\x10\x02\x12\x0c\n\x08tdynamic\x10\x03\x12\n\n\x06tghost\x10\x04P\x00\x62\x06proto3')
  ,
...
_PHYSICSDATA_PHYSICSSHAPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='smesh', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ssphere', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='shull', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='sbox', index=4, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='scapsule', index=5, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='scylinder', index=6, number=6,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='scone', index=7, number=7,
      options=None,
      type=None),
  ],
...
_RIGIDBODY_RIGIDBODYTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='tnone', index=1, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='tstatic', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='tdynamic', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='tghost', index=4, number=4,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_CONSTRAINTGENERIC.fields_by_name['pivotA'].message_type = xbuf_dot_primitives__pb2._VEC3
_CONSTRAINTGENERIC.fields_by_name['pivotB'].message_type = xbuf_dot_primitives__pb2._VEC3
_CONSTRAINTGENERIC.fields_by_name['upperLinearLimit'].message_type = xbuf_dot_primitives__pb2._VEC3
_CONSTRAINTGENERIC.fields_by_name['lowerLinearLimit'].message_type = xbuf_dot_primitives__pb2._VEC3
_CONSTRAINTGENERIC.fields_by_name['upperAngularLimit'].message_type = xbuf_dot_primitives__pb2._VEC3
_CONSTRAINTGENERIC.fields_by_name['lowerAngularLimit'].message_type = xbuf_dot_primitives__pb2._VEC3
...
_RIGIDBODY.fields_by_name['angularFactor'].message_type = xbuf_dot_primitives__pb2._VEC3
_RIGIDBODY.fields_by_name['linearFactor'].message_type = xbuf_dot_primitives__pb2._VEC3
