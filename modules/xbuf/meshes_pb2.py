...
_VERTEXARRAY_ATTRIB = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='tbn_to_model_quat', index=15, number=15,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_VERTEXARRAY_ATTRIB.values_by_name["normal"].has_options = True
_VERTEXARRAY_ATTRIB.values_by_name["normal"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\010\001'))
_VERTEXARRAY_ATTRIB.values_by_name["tangent"].has_options = True
_VERTEXARRAY_ATTRIB.values_by_name["tangent"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\010\001'))
_VERTEXARRAY_ATTRIB.values_by_name["bitangent"].has_options = True
_VERTEXARRAY_ATTRIB.values_by_name["bitangent"]._options = _descriptor._ParseOptions(descriptor_pb2.EnumValueOptions(), _b('\010\001'))
